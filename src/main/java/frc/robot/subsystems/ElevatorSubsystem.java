...
import frc.robot.commands.ManualElevatorControlCommand;

import static frc.robot.RobotMap.ELEVATOR_MASTER_MOTOR;
import static frc.robot.RobotMap.ELEVATOR_SLAVE_MOTOR;
